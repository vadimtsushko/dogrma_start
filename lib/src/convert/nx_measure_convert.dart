...
library dogma_start.src.convert.nx_measure_convert;
...
class NxMeasureDecoder extends Converter<Map, NxMeasure>
  ...
  NxMeasureDecoder.using(this._nxInlineMeasureDefDecoder,
      this._nxAttrExprDefDecoder, this._nxValueExprDecoder);
  @override
...
class NxMeasureEncoder extends Converter<NxMeasure, Map>
  ...
  NxMeasureEncoder.using(this._nxInlineMeasureDefEncoder,
      this._nxAttrExprDefEncoder, this._nxValueExprEncoder);
  @override
